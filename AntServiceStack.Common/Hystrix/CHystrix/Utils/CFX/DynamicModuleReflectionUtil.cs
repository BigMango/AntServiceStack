    ...
    internal sealed class DynamicModuleReflectionUtil
    {
        ...
        private static DynamicModuleReflectionUtil GetInstance()
        {
            try
            {
                ...
                Type type4 = typeof(ConfigurationElementCollection);
                string fieldName = "bReadOnly";
                bool flag2 = false;
                Type fieldType = typeof(bool);
                util._fi_ConfigurationElementCollection_bReadOnly = CommonReflectionUtil.FindField(type4, fieldName, flag2, fieldType);
                Type type6 = CommonAssemblies.SystemWeb.GetType("System.Web.ModuleConfigurationInfo");
                Type type7 = type6;
                bool flag3 = false;
                Type[] argumentTypes = new Type[] { typeof(string), typeof(string), typeof(string) };
                util._ci_ModuleConfigurationInfo = CommonReflectionUtil.FindConstructor(type7, flag3, argumentTypes);
                Type type8 = typeof(List<>).MakeGenericType(new Type[] { type6 });
                util._type_ListOfModuleConfigurationInfo = type8;
                Type type9 = type8;
                bool flag4 = false;
                Type[] typeArray3 = Type.EmptyTypes;
                util._ci_ListOfModuleConfigurationInfo = CommonReflectionUtil.FindConstructor(type9, flag4, typeArray3);
                Type type10 = typeof(HttpApplication);
                string str3 = "_moduleConfigInfo";
                bool flag5 = true;
                Type type11 = type8;
                util._fi_HttpApplication_moduleConfigInfo = CommonReflectionUtil.FindField(type10, str3, flag5, type11);
                Type type12 = typeof(HttpApplication);
                string str4 = "_moduleCollection";
                bool flag6 = false;
                Type type13 = typeof(HttpModuleCollection);
                util._fi_HttpApplication_moduleCollection = CommonReflectionUtil.FindField(type12, str4, flag6, type13);
                Type type15 = CommonAssemblies.SystemWeb.GetType("System.Web.Hosting.PipelineRuntime");
                ...
                bool flag8 = false;
                Type[] typeArray4 = new Type[] { typeof(IntPtr) };
                Type type18 = typeof(HttpModuleCollection);
                util._mi_HttpApplication_GetModuleCollection = CommonReflectionUtil.FindMethod(type17, str6, flag8, typeArray4, type18);
                Type type19 = typeof(HttpApplication);
                string str7 = "BuildIntegratedModuleCollection";
                bool flag9 = false;
                Type[] typeArray5 = new Type[] { type8 };
                Type type20 = typeof(HttpModuleCollection);
                util._mi_HttpApplication_BuildIntegratedModuleCollection = CommonReflectionUtil.FindMethod(type19, str7, flag9, typeArray5, type20);
                Type type21 = typeof(HttpModuleCollection);
                string str8 = "AddModule";
                bool flag10 = false;
                Type[] typeArray6 = new Type[] { typeof(string), typeof(IHttpModule) };
                Type type22 = typeof(void);
                util._mi_HttpModuleCollection_AddModule = CommonReflectionUtil.FindMethod(type21, str8, flag10, typeArray6, type22);
                return util;
            }
            catch
            {
