namespace AntServiceStack.Common.Hystrix.Util
{
    ...
    public class HystrixRollingPercentile
    {
        ...
        /// </summary>
        private static readonly ILog Logger = LogManager.GetLogger(typeof(HystrixRollingPercentile));
        ...
        public long GetSum()
        {
            ...
            // Fetch the current snapshot
            return this.CurrentPercentileSnapshot.Sum;
        }
        ...
        public long GetMax()
        {
            ...
            // Fetch the current snapshot
            return this.CurrentPercentileSnapshot.Max;
        }
        ...
        public long GetMin()
        {
            ...
            // Fetch the current snapshot
            return this.CurrentPercentileSnapshot.Min;
        }
        ...
        public long GetCount()
        {
            ...
            // Fetch the current snapshot
            return this.CurrentPercentileSnapshot.Count;
        }

        public void GetAuditData(out int count, out long sum, out long mean, out long min, out long max)
        {
            // No-op if disabled
            if (!this.enabled.Get())
            {
            ...
            // Fetch the current snapshot
            count = this.CurrentPercentileSnapshot.Count;
            sum = this.CurrentPercentileSnapshot.Sum;
            mean = this.CurrentPercentileSnapshot.Mean;
            min = this.CurrentPercentileSnapshot.Min;
            max = this.CurrentPercentileSnapshot.Max;
        }

        public int GetItemCountInRange(int low, int? high = null)
        {
            // No-op if disabled
            if (!this.enabled.Get())
            {
            ...
            // Fetch the current snapshot
            return this.CurrentPercentileSnapshot.GetItemCountInRange(low, high);
        }
        ...
        internal class PercentileSnapshot
        {
            ...
            public long Mean { get; private set; }
            public int Count
            {
                get
                {
            ...
            public int GetItemCountInRange(int low, int? high = null)
            {
                ...
                {
                    if (item >= low && (high == null || item < high))
                        count++;
                }
