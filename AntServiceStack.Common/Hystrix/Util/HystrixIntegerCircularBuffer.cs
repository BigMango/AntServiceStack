...
{
    public class HystrixIntegerCircularBuffer : HystrixCircularBuffer<long>
    {
        public HystrixIntegerCircularBuffer(int timeWindowInSeconds, int bucketTimeWindowInSeconds, int bucketSizeLimit) : base(timeWindowInSeconds, bucketTimeWindowInSeconds, bucketSizeLimit)
        {
        }
