...
namespace AntServiceStack.Common.Hystrix
{
    public class HystrixCommandPropertiesSetter
    {
        ...
        public int? MetricsIntegerBufferTimeWindowInSeconds { get; private set; }
        public int? MetricsIntegerBufferBucketTimeWindowInSeconds { get; private set; }
        public int? MetricsIntegerBufferBucketSizeLimit { get; private set; }
        ...
        public HystrixCommandPropertiesSetter WithMetricsIntegerBufferTimeWindowInSeconds(int value)
        {
            MetricsIntegerBufferTimeWindowInSeconds = value;
            return this;
        }
        public HystrixCommandPropertiesSetter WithMetricsIntegerBufferBucketTimeWindowInSeconds(int value)
        {
            MetricsIntegerBufferBucketTimeWindowInSeconds = value;
            return this;
        }
        public HystrixCommandPropertiesSetter WithMetricsIntegerBufferBucketSizeLimit(int value)
        {
            MetricsIntegerBufferBucketSizeLimit = value;
            return this;
        }
