namespace AntServiceStack.Threading
{
    ...
    public class WorkItemInfo
    {
        public WorkItemInfo()
        {
            UseCallerCallContext = CThreadPool.DefaultUseCallerCallContext;
            UseCallerHttpContext = CThreadPool.DefaultUseCallerHttpContext;
            DisposeOfStateObjects = CThreadPool.DefaultDisposeOfStateObjects;
            PostExecuteWorkItemCallback = CThreadPool.DefaultPostExecuteWorkItemCallback;
            WorkItemPriority = CThreadPool.DefaultWorkItemPriority;
        }
