...
namespace AntServiceStack.Threading.Internal
{
    ...
    public partial class WorkItem : IHasWorkItemPriority
    {
        ...
        /// <summary>
        /// A reference to an object that indicates whatever the 
        /// CThreadPool has been canceled
        /// </summary>
        private CanceledWorkItemsGroup _canceledCThreadPool = CanceledWorkItemsGroup.NotCanceledWorkItemsGroup;
        ...
        /// <summary>
        /// Stores how long the work item waited on the ctp queue
        /// </summary>
        ...
        internal CanceledWorkItemsGroup CanceledCThreadPool
        {
            get { return _canceledCThreadPool; }
            set { _canceledCThreadPool = value; }
        }
        ...
        private void ExecuteWorkItem()
        {
            ...
            catch (ThreadAbortException tae)
            {
                ...
                // If we got a ThreadAbortException and the CTP is not shutting down, it means the 
                // work items was cancelled.
                if (!CThreadPool.CurrentThreadEntry.AssociatedCThreadPool.IsShuttingdown)
                {
                    Thread.ResetAbort();
                }
            }
            ...
            if (!CThreadPool.IsWorkItemCanceled)
            {
