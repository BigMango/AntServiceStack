...
namespace AntServiceStack.Threading.Internal
{
    public abstract class WorkItemsGroupBase : IWorkItemsGroup
    {
        ...
        /// <summary>
        /// Contains the name of this instance of CThreadPool.
        ...
        /// <summary>
        /// Get/Set the name of the CThreadPool/WorkItemsGroup instance
        /// </summary>
        public string Name
        {
            get { return _name; }
        ...
        /// <summary>
        /// Wait for the CThreadPool/WorkItemsGroup to be idle
        /// </summary>
        ...
        {
            return QueueWorkItem(action, CThreadPool.DefaultWorkItemPriority);
        }
        ...
        {
            return QueueWorkItem<T>(action, arg, CThreadPool.DefaultWorkItemPriority);
        }
        ...
        {
            return QueueWorkItem<T1, T2>(action, arg1, arg2, CThreadPool.DefaultWorkItemPriority);
        }
        ...
        {
            return QueueWorkItem<T1, T2, T3>(action, arg1, arg2, arg3, CThreadPool.DefaultWorkItemPriority);
            ;
        }
            ...
            Action<T1, T2, T3, T4> action, T1 arg1, T2 arg2, T3 arg3, T4 arg4)
        {
            return QueueWorkItem<T1, T2, T3, T4>(action, arg1, arg2, arg3, arg4,
                                                  CThreadPool.DefaultWorkItemPriority);
        }
