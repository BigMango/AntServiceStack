...
namespace AntServiceStack.Threading
{
    ...
    public class WIGStartInfo
    {
        ...
        public WIGStartInfo()
        {
            _fillStateWithArgs = CThreadPool.DefaultFillStateWithArgs;
            _workItemPriority = CThreadPool.DefaultWorkItemPriority;
            _startSuspended = CThreadPool.DefaultStartSuspended;
            _postExecuteWorkItemCallback = CThreadPool.DefaultPostExecuteWorkItemCallback;
            _disposeOfStateObjects = CThreadPool.DefaultDisposeOfStateObjects;
            _useCallerHttpContext = CThreadPool.DefaultUseCallerHttpContext;
            _useCallerCallContext = CThreadPool.DefaultUseCallerCallContext;
        }
