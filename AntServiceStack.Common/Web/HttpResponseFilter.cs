...
namespace AntServiceStack.Common.Web
{
    public class HttpResponseFilter : IContentTypeFilter
    {
        ...
        public string GetFormatContentType(string format)
        {
            ...
            string contentType;
            ContentTypeFormats.TryGetValue(format, out contentType);
            return contentType;
        }
        ...
        public StreamDeserializerDelegate GetStreamDeserializer(string contentType)
        {
            ...
            {
                case EndpointAttributes.Xml:
                    return WrappedXmlSerializer.DeserializeFromStream;

                case EndpointAttributes.Json:
                    return WrappedJsonDeserializer.Instance.DeserializeFromStream;
