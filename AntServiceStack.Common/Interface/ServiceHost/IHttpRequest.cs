...
namespace AntServiceStack.ServiceHost
{
    ...
    public interface IHttpRequest : IResolver
    {
        ...
        /// <summary>
        /// The name of the service being called (e.g. Target service method name)
        /// </summary>
        ...
        /// <summary>
        /// The value of request deserialization time in millisecond
        /// </summary>
        long DeserializationTimeInMillis { get; set; }
    }
}
#endif
