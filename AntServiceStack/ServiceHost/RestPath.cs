...
namespace AntServiceStack.ServiceHost
{
        ...
        : IRestPath
    {
        ...
        // The service method map to this rest path
        public MethodInfo ServiceMethod { get; private set; }

        // The service method name map to this rest path
        public string OperationName { get; private set; }

        // The request type map to this rest path
        ...
        public RestPath(MethodInfo serviceMethod, string path) : this(serviceMethod, path, null) { }

        /// <summary>
        /// 构造方法
        /// </summary>
        /// <param name="serviceMethod">action方法</param>
        /// <param name="path">执行路由</param>
        /// <param name="verbs">POST GET DELETE PUT等等</param>
        /// <param name="summary">描述</param>
        /// <param name="notes"></param>
        public RestPath(MethodInfo serviceMethod, string path, string verbs, string summary = null, string notes = null)
        {
            this.ServiceMethod = serviceMethod;
            this.OperationName = serviceMethod.Name;
            this.RequestType = serviceMethod.GetParameters()[0].ParameterType;
            ...
            foreach (var component in this.restPath.Split(PathSeperatorChar))//PathSeperatorChar = '/'
            {
        ...
        public object CreateRequestObject(string pathInfo)
        {
            return CreateRequestObject(pathInfo, null, null);
        }

        public object CreateRequestObject(string pathInfo, Dictionary<string, string> queryStringAndFormData, object fromInstance)
        {
