...
namespace AntServiceStack.Plugins.Consul
{
    ...
    public interface IServiceDiscovery<out TServiceModel, TServiceRegistration> where TServiceModel : class where TServiceRegistration : class
    {
        /// <summary>
        /// Holds the current service registration
        /// </summary>
        List<TServiceRegistration> Registration { get; }
