...
namespace AntServiceStack.WebHost.Endpoints.Extensions
{
    public static class HttpResponseStreamExtensions
    {
        ...
        public static void CloseOutputStream(this HttpResponse response)
        {
            ...
            {
                Log.Error("Exception closing HttpResponse: " + ex.Message, ex, new Dictionary<string, string>(){ { "ErrorCode", "FXD300010" } });
            }
        }
        ...
        public static void CloseOutputStream(this HttpListenerResponse response)
        {
            ...
            {
                Log.Error("Error in HttpListenerResponseWrapper: " + ex.Message, ex, new Dictionary<string, string>(){ { "ErrorCode", "FXD300010" } });
            }
        }
