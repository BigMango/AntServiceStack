...
namespace AntServiceStack.Validation
{
    ...
    {
        /// <summary>
        /// Converts the validation result to an error result which will be serialized by AntServiceStack in a clean and human-readable way.
        /// </summary>
        ...
        /// <summary>
        /// Converts the validation result to an error exception which will be serialized by AntServiceStack in a clean and human-readable way
