    ...
    public static class ObjectUtils
    {
        ...
        public static int GetHashCode(IEnumerable enumerable)
        {
            ...
            foreach (var obj in enumerable)
            {
                ...
                int objHash = innerEnum == null ? obj.GetHashCode() : GetHashCode(innerEnum);
                unchecked
                {
        ...
        public static bool AreEqual(object o1, object o2)
        {
            ...
            if (o1 is Array)
            {
                return o2 is Array && AreEqual(o1 as Array, o1 as Array);
            }
            if (o1 is IDictionary<string, object>)
            {
                return o2 is IDictionary<string, object> &&
                       AreEqual(o1 as IDictionary<string, object>, o1 as IDictionary<string, object>);
            }
            return o1.Equals(o2);
        }
