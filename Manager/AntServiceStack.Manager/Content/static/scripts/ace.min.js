jQuery(function () {
    ...
    $("#sidebar-collapse").on("click", function () {
        ...
        if (a) {
            ...
            $.cookie('menuStatus', '', {expires: -1});
        }
        else {
            $.cookie('menuStatus', 'ok');
        }
    });
    ...
    $(document).bind("scroll", function () {
        var obj = document.getElementById("btn-scroll-up");
        if(!obj){
            return;
        }
        if ($('body').scrollTop()) {
            obj.style.display = "";
            obj.style.top=document.documentElement.clientHeight-35+$('body').scrollTop() + 'px';
        } else {
    ...
    $('body').bind('click',function(event){
        if( $("#ace-settings-btn")){
            if($("#ace-settings-btn").hasClass('open')) {
...
function AutoGoTopEx() {
    debugger;
    var obj = document.getElementById("btn-scroll-up");

    function getScrollTop() {
        console.log(top.parent.document.documentElement.scrollTop);
        return top.parent.document.documentElement.scrollTop;
    }
...
function general_things() {
    ...
    $("#ace-settings-box").on("click",function(event){
        var target = event.target;
        if(target && $(target).hasClass('btn-colorpicker')){
