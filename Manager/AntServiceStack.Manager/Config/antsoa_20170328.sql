...
MySQL - 5.6.26-log : Database - antsoa
*********************************************************************
*/
...
CREATE TABLE `nodes` (
  ...
  `ServiceFullName` varchar(100) DEFAULT NULL COMMENT '服务全名称',
  `Type` int(1) NOT NULL DEFAULT '0' COMMENT '服务类型(0自注册 1consu)',
  PRIMARY KEY (`Tid`)
) ENGINE=InnoDB AUTO_INCREMENT=19 DEFAULT CHARSET=utf8 COMMENT='服务节点';
