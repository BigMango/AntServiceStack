...
using System.Text;
using AntServiceStack.ProtoBuf.Serializers;
...
namespace AntServiceStack.ProtoBuf.Meta
{
    /// <summary>
    ...
    public class MetaType : ISerializerProxy
    {
        ...
        internal static bool GetAsReferenceDefault(RuntimeTypeModel model, Type type)
        {
            ...
            {
                if (typeAttribs[i].AttributeType.FullName == "AntServiceStack.ProtoBuf.ProtoContractAttribute")
                {
                    object tmp;
        ...
        internal void ApplyDefaultBehaviour()
        {
            ...
            for (int i = 0; i < typeAttribs.Length; i++)
            {
                ...
                if (!isEnum && fullAttributeTypeName == "AntServiceStack.ProtoBuf.ProtoIncludeAttribute")
                {
                    int tag = 0;
                ...
                if (fullAttributeTypeName == "AntServiceStack.ProtoBuf.ProtoPartialIgnoreAttribute")
                {
                ...
                if (!isEnum && fullAttributeTypeName == "AntServiceStack.ProtoBuf.ProtoPartialMemberAttribute")
                {
                    if (partialMembers == null) partialMembers = new BasicList();
                    partialMembers.Add(item);
                }

                if (fullAttributeTypeName == "AntServiceStack.ProtoBuf.ProtoContractAttribute")
                {
            ...
            foreach (MemberInfo member in foundList)
            {
                ...
                } else if ((method = member as MethodInfo) != null)
                {
                    ...
                    {
                        CheckForCallback(method, memberAttribs, "AntServiceStack.ProtoBuf.ProtoBeforeSerializationAttribute", ref callbacks, 0);
                        CheckForCallback(method, memberAttribs, "AntServiceStack.ProtoBuf.ProtoAfterSerializationAttribute", ref callbacks, 1);
                        CheckForCallback(method, memberAttribs, "AntServiceStack.ProtoBuf.ProtoBeforeDeserializationAttribute", ref callbacks, 2);
                        CheckForCallback(method, memberAttribs, "AntServiceStack.ProtoBuf.ProtoAfterDeserializationAttribute", ref callbacks, 3);
        ...
        internal static AttributeFamily GetContractFamily(RuntimeTypeModel model, Type type, AttributeMap[] attributes)
        {
            ...
            for (int i = 0; i < attributes.Length; i++)
            {
                ...
                {
                    case "AntServiceStack.ProtoBuf.ProtoContractAttribute":
                        bool tmp = false;
        ...
        private static ProtoMemberAttribute NormalizeProtoMember(TypeModel model, MemberInfo member, AttributeFamily family, bool forced, bool isEnum, BasicList partialMembers, int dataMemberOffset, bool inferByTagName)
        {
            ...
            if (isEnum)
            {
                attrib = GetAttribute(attribs, "AntServiceStack.ProtoBuf.ProtoIgnoreAttribute");
                if (attrib != null)
                {
                    ignore = true;
                }
                ...
                {
                    attrib = GetAttribute(attribs, "AntServiceStack.ProtoBuf.ProtoEnumAttribute");
            ...
            {
                attrib = GetAttribute(attribs, "AntServiceStack.ProtoBuf.ProtoMemberAttribute");
                GetIgnore(ref ignore, attrib, attribs, "AntServiceStack.ProtoBuf.ProtoIgnoreAttribute");
