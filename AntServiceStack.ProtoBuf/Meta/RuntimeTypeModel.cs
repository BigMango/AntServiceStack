...
namespace AntServiceStack.ProtoBuf.Meta
{
    ...
    public sealed class RuntimeTypeModel : TypeModel
    {
        ...
        private const uint
           ...
           OPTIONS_SupportNull = 256;

        private bool GetOption(uint option)
        {
            return (options & option) == option;
        }
        private void SetOption(uint option, bool value)
        {
            if (value) options |= option;
            else options &= (uint)~option;
        }
        /// <summary>
        /// Global default that
        ...
        {
            get { return GetOption(OPTIONS_SupportNull); }
            set { SetOption(OPTIONS_SupportNull, value); }
        }
        ...
        /// <summary>
        /// The default model, used to support AntServiceStack.ProtoBuf.Serializer
        /// </summary>
