...
namespace AntServiceStack.Text
{
    ...
    public static class ReflectionExtensions
    {
        ...
        const string XmlIgnore = "XmlIgnoreAttribute"; // added by William
        ...
        public static PropertyInfo[] GetSerializableProperties(this Type type)
        {
            ...
            return publicReadableProperties.Where(prop => !prop.CustomAttributes(false).Any(attr => (attr.GetType().Name == IgnoreDataMember || attr.GetType().Name == XmlIgnore))).ToArray();
        }
