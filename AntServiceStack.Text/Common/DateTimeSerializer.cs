...
using System.Text;
using System.Xml;
using AntServiceStack.Text.Json;
...
namespace AntServiceStack.Text.Common
{
    public static class DateTimeSerializer
    {
        ...
        public const string LongDateTimeFormat = "yyyy-MM-dd HH:mm:ss";                       //20
        public const string LongDateTimeFormatWithFraction = "yyyy-MM-dd HH:mm:ss.fff";       //24
        public const string LongDateTimeFormatWithTimeZone = "yyyy-MM-dd HH:mm:ss zzz";       //24
        ...
        public const string LongDateTimeMaxString = "9999-12-31 23:59:59";
        ...
        public static DateTime ParseShortestXsdDateTime(string dateTimeStr)
        {
            ...
            if (dateTimeStr.Length == DefaultDateTimeFormat.Length
                ...
                || dateTimeStr.Length == LongDateTimeFormat.Length
                || dateTimeStr.Length == LongDateTimeFormatWithFraction.Length)
            {
                if (JsConfig.DateHandler == JsonDateHandler.LongDateTime && dateTimeStr == LongDateTimeMaxString)
                    return DateTime.MaxValue.Prepare();
        ...
        public static DateTime ParseWcfJsonDate(string wcfJsonDate)
        {
            ...
            if (JsConfig.DateHandler == JsonDateHandler.DCJSCompatible || timeZone == UnspecifiedOffset)
            {
                DateTime value = unixTime.FromUnixTimeMs();
        ...
        public static void WriteWcfJsonDate(TextWriter writer, DateTime dateTime)
        {
            ...
            if (JsConfig.DateHandler == JsonDateHandler.LongDateTime)
            {
                writer.Write(dateTime.ToString(LongDateTimeFormat, CultureInfo.InvariantCulture));
                return;
            }
        ...
        public static void WriteWcfJsonDateTimeOffset(TextWriter writer, DateTimeOffset dateTimeOffset)
        {
            ...
            if (JsConfig.DateHandler == JsonDateHandler.LongDateTime)
            {
                writer.Write(dateTimeOffset.ToString(LongDateTimeFormatWithTimeZone, CultureInfo.InvariantCulture));
                return;
            }
