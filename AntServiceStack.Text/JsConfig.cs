...
namespace AntServiceStack.Text
{
        ...
        JsConfig
    {
        ...
        public static void UseStandardLongDateTime()
        {
            DateHandler = JsonDateHandler.LongDateTime;
            TimeSpanHandler = JsonTimeSpanHandler.StandardFormat;
        }
        ...
        /// <summary>
        /// Whether filter the \r\n char in base64 string when convert base64 string to byte[]
        /// </summary>
        private static bool? sFilterEnterCharsInBase64String;
        public static bool FilterEnterCharsInBase64String
        {
            get
            {
                return (JsConfigScope.Current != null ? JsConfigScope.Current.FilterEnterCharsInBase64String : null)
                    ?? sFilterEnterCharsInBase64String
                    ?? false;
            }
            set
            {
                if (!sFilterEnterCharsInBase64String.HasValue) sFilterEnterCharsInBase64String = value;
            }
        }
