...
namespace Ant.Tools.SOA.ContractFirst
{
	public sealed class ConfigurationManager 
	{
        ...
        public bool CanRead 
        {
            get
            {
                return isoStore != null && isoStore.FileExists(fileName);
            }
        }
		...
		private void WriteBackConfiguration()
		{
			...
			try
			{
				streamWriter = new StreamWriter(new IsolatedStorageFileStream(this.fileName, FileMode.Create, this.isoStore), Encoding.UTF8);
