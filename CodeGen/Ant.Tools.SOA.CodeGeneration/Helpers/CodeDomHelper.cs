...
namespace Ant.Tools.SOA.CodeGeneration.Helpers
{
    using System;
    ...
    internal static class CodeDomHelper
    {
        ...
        /// <summary>
        /// Add to CodeCommentStatementCollection non-documentation comment
        /// </summary>
        /// <param name="codeStatmentColl">Collection of CodeCommentStatement</param>
        /// <param name="comment">comment text</param>
        internal static void CreateNonDococumentComment(CodeCommentStatementCollection codeStatmentColl, string comment)
        {
            codeStatmentColl.Add(new CodeCommentStatement(comment, false));
        }
