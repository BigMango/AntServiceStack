...
namespace CTrip.Tools.SOA.ServiceDescription
{
    ...
    /// typed collections of <see cref="Message"/> elements.
    /// </summary>
    /// <remarks>
    /// <b>IMessageCollection</b> provides an <see cref="ICollection"/>
    /// that is strongly typed for <see cref="Message"/> elements.
    /// </remarks>

    public interface IMessageCollectionType
    {
        #region Properties
        #region Count
        ...
        /// <see cref="IMessageCollectionType"/>.
        /// </summary>
        /// <value>The number of elements contained in the
        /// <see cref="IMessageCollectionType"/>.</value>
        ...
        /// <see cref="IMessageCollectionType"/> is synchronized (thread-safe).
        /// </summary>
        /// <value><c>true</c> if access to the <see cref="IMessageCollectionType"/> is
        ...
        /// to the <see cref="IMessageCollectionType"/>.
        /// </summary>
        /// <value>An object that can be used to synchronize access
        /// to the <see cref="IMessageCollectionType"/>.</value>
        ...
        /// <summary>
        /// Copies the entire <see cref="IMessageCollectionType"/> to a one-dimensional <see cref="Array"/>
        /// of <see cref="Message"/> elements, starting at the specified index of the target array.
        /// </summary>
        /// <param name="array">The one-dimensional <see cref="Array"/> that is the destination of the
        /// <see cref="Message"/> elements copied from the <see cref="IMessageCollectionType"/>.
        ...
        /// The number of elements in the source <see cref="IMessageCollectionType"/> is greater
        /// than the available space from <paramref name="arrayIndex"/> to the end of the destination
        /// <paramref name="array"/>.</para></exception>
        /// <remarks>Please refer to <see cref="ICollection.CopyTo"/> for details.</remarks>

        void CopyTo(Message[] array, int arrayIndex);

        #endregion
        #region GetEnumerator

        /// <summary>
        /// Returns an <see cref="IMessageEnumerator"/> that can
        /// iterate through the <see cref="IMessageCollectionType"/>.
        /// </summary>
        /// <returns>An <see cref="IMessageEnumerator"/>
        /// for the entire <see cref="IMessageCollectionType"/>.</returns>
        /// <remarks>Please refer to <see cref="IEnumerable.GetEnumerator"/> for details.</remarks>

        IMessageEnumerator GetEnumerator();
    ...
    #endregion
    #region Interface IMessageList

    /// <summary>
    /// Represents a strongly typed collection of <see cref="Message"/>
    /// objects that can be individually accessed by index.
    /// </summary>
    /// <remarks>
    /// <b>IMessageList</b> provides an <see cref="IList"/>
    /// that is strongly typed for <see cref="Message"/> elements.
    /// </remarks>

    public interface
        IMessageList : IMessageCollectionType
    {
        #region Properties
        #region IsFixedSize

        /// <summary>
        /// Gets a value indicating whether the <see cref="IMessageList"/> has a fixed size.
        /// </summary>
        /// <value><c>true</c> if the <see cref="IMessageList"/> has a fixed size;
        ...
        /// <summary>
        /// Gets a value indicating whether the <see cref="IMessageList"/> is read-only.
        /// </summary>
        /// <value><c>true</c> if the <see cref="IMessageList"/> is read-only;
        /// otherwise, <c>false</c>. The default is <c>false</c>.</value>
        ...
        /// <summary>
        /// Gets or sets the <see cref="Message"/> element at the specified index.
        /// </summary>
        /// <param name="index">The zero-based index of the
        /// <see cref="Message"/> element to get or set.</param>
        /// <value>
        /// The <see cref="Message"/> element at the specified <paramref name="index"/>.
        /// </value>
        /// <exception cref="ArgumentOutOfRangeException">
        /// <para><paramref name="index"/> is less than zero.</para>
        /// <para>-or-</para>
        /// <para><paramref name="index"/> is equal to or greater than
        /// <see cref="IMessageCollectionType.Count"/>.</para>
        /// </exception>
        /// <exception cref="NotSupportedException">
        /// The property is set and the <see cref="IMessageList"/> is read-only.</exception>
        /// <remarks>Please refer to <see cref="IList.this"/> for details.</remarks>

        Message this[int index] { get; set; }
        ...
        /// <summary>
        /// Adds a <see cref="Message"/> to the end
        /// of the <see cref="IMessageList"/>.
        /// </summary>
        /// <param name="value">The <see cref="Message"/> object
        /// to be added to the end of the <see cref="IMessageList"/>.
        /// This argument can be a null reference.
        /// </param>
        /// <returns>The <see cref="IMessageList"/> index at which
        /// the <paramref name="value"/> has been added.</returns>
        /// <exception cref="NotSupportedException">
        /// <para>The <see cref="IMessageList"/> is read-only.</para>
        /// <para>-or-</para>
        /// <para>The <b>IMessageList</b> has a fixed size.</para></exception>
        /// <remarks>Please refer to <see cref="IList.Add"/> for details.</remarks>

        int Add(Message value);

        #endregion
        #region Clear

        /// <summary>
        /// Removes all elements from the <see cref="IMessageList"/>.
        /// </summary>
        /// <exception cref="NotSupportedException">
        /// <para>The <see cref="IMessageList"/> is read-only.</para>
        /// <para>-or-</para>
        ...
        /// <summary>
        /// Determines whether the <see cref="IMessageList"/>
        /// contains the specified <see cref="Message"/> element.
        /// </summary>
        /// <param name="value">The <see cref="Message"/> object
        /// to locate in the <see cref="IMessageList"/>.
        /// This argument can be a null reference.
        /// </param>
        /// <returns><c>true</c> if <paramref name="value"/> is found in the
        /// <see cref="IMessageList"/>; otherwise, <c>false</c>.</returns>
        /// <remarks>Please refer to <see cref="IList.Contains"/> for details.</remarks>

        bool Contains(Message value);
        ...
        /// <see cref="Message"/> in the <see cref="IMessageList"/>.
        /// </summary>
        /// <param name="value">The <see cref="Message"/> object
        /// to locate in the <see cref="IMessageList"/>.
        /// This argument can be a null reference.
        ...
        /// in the <see cref="IMessageList"/>, if found; otherwise, -1.
        /// </returns>
        /// <remarks>Please refer to <see cref="IList.IndexOf"/> for details.</remarks>

        int IndexOf(Message value);

        #endregion
        #region Insert

        /// <summary>
        /// Inserts a <see cref="Message"/> element into the
        /// <see cref="IMessageList"/> at the specified index.
        /// </summary>
        /// <param name="index">The zero-based index at which
        /// <paramref name="value"/> should be inserted.</param>
        /// <param name="value">The <see cref="Message"/> object
        /// to insert into the <see cref="IMessageList"/>.
        /// This argument can be a null reference.
        /// </param>
        /// <exception cref="ArgumentOutOfRangeException">
        /// <para><paramref name="index"/> is less than zero.</para>
        ...
        void Insert(int index, Message value);

        #endregion
        #region Remove

        /// <summary>
        /// Removes the first occurrence of the specified <see cref="Message"/>
        /// from the <see cref="IMessageList"/>.
        /// </summary>
        /// <param name="value">The <see cref="Message"/> object
        /// to remove from the <see cref="IMessageList"/>.
        /// This argument can be a null reference.
        /// </param>
        /// <exception cref="NotSupportedException">
        /// <para>The <see cref="IMessageList"/> is read-only.</para>
    ...
    #endregion
    #region Interface IMessageEnumerator

    /// <summary>
    /// Supports type-safe iteration over a collection that
    /// contains <see cref="Message"/> elements.
    /// </summary>
    /// <remarks>
    /// <b>IMessageEnumerator</b> provides an <see cref="IEnumerator"/>
    /// that is strongly typed for <see cref="Message"/> elements.
    /// </remarks>
    ...
    public interface IMessageEnumerator
    {
        ...
        /// <summary>
        /// Gets the current <see cref="Message"/> element in the collection.
        /// </summary>
        /// <value>The current <see cref="Message"/> element in the collection.</value>
    ...
    /// <summary>
    /// Implements a strongly typed collection of <see cref="Message"/> elements.
    /// </summary>
    /// <remarks><para>
    /// <b>Messages</b> provides an <see cref="ArrayList"/>
    /// that is strongly typed for <see cref="Message"/> elements.
    /// </para></remarks>

    [Serializable]
    public class MessagesCollection :
        IMessageList, IList, ICloneable
    {
        ...
        private MessagesCollection(Tag tag) { }
        ...
        {
            this._array = new Message[_defaultCapacity];
        }

        #endregion
        #region Messages(Int32)
        ...
        /// <see cref="MessagesCollection"/> is initially capable of storing.</param>
        /// <exception cref="ArgumentOutOfRangeException">
        /// <paramref name="capacity"/> is less than zero.</exception>
        /// <remarks>Please refer to <see cref="ArrayList(Int32)"/> for details.</remarks>

        public MessagesCollection(int capacity)
        {
            if (capacity < 0)
                throw new ArgumentOutOfRangeException("capacity",
                    capacity, "Argument cannot be negative.");

            this._array = new Message[capacity];
        }
        ...
        /// <summary>
        /// Gets the list of elements contained in the <see cref="MessagesCollection"/> instance.
        /// </summary>
        /// <value>
        /// A one-dimensional <see cref="Array"/> with zero-based indexing that contains all 
        /// <see cref="Message"/> elements in the <see cref="MessagesCollection"/>.
        /// </value>
        /// <remarks>
        /// Use <b>InnerArray</b> to access the element array of a <see cref="MessagesCollection"/>
        ...
        protected virtual Message[] InnerArray
        {
        ...
        /// <summary>
        /// Gets or sets the capacity of the <see cref="MessagesCollection"/>.
        /// </summary>
        /// <value>The number of elements that the
        /// <see cref="MessagesCollection"/> can contain.</value>
        /// <exception cref="ArgumentOutOfRangeException">
        ...
        public virtual int Capacity
        {
            ...
            set
            {
                ...
                Message[] newArray = new Message[value];
        ...
        /// <summary>
        /// Gets the number of elements contained in the <see cref="MessagesCollection"/>.
        /// </summary>
        /// <value>
        /// The number of elements contained in the <see cref="MessagesCollection"/>.
        /// </value>
        ...
        /// <summary>
        /// Gets a value indicating whether the <see cref="MessagesCollection"/> has a fixed size.
        /// </summary>
        /// <value><c>true</c> if the <see cref="MessagesCollection"/> has a fixed size;
        /// otherwise, <c>false</c>. The default is <c>false</c>.</value>
        ...
        /// <summary>
        /// Gets a value indicating whether the <see cref="MessagesCollection"/> is read-only.
        /// </summary>
        /// <value><c>true</c> if the <see cref="MessagesCollection"/> is read-only;
        /// otherwise, <c>false</c>. The default is <c>false</c>.</value>
        ...
        /// <summary>
        /// Gets a value indicating whether access to the <see cref="MessagesCollection"/>
        /// is synchronized (thread-safe).
        /// </summary>
        /// <value><c>true</c> if access to the <see cref="MessagesCollection"/> is
        /// synchronized (thread-safe); otherwise, <c>false</c>. The default is <c>false</c>.</value>
        ...
        /// <summary>
        /// Gets a value indicating whether the <see cref="MessagesCollection"/> 
        /// ensures that all elements are unique.
        /// </summary>
        /// <value>
        /// <c>true</c> if the <see cref="MessagesCollection"/> ensures that all 
        /// elements are unique; otherwise, <c>false</c>. The default is <c>false</c>.
        /// </value>
        /// <remarks>
        /// <b>IsUnique</b> returns <c>true</c> exactly if the <see cref="MessagesCollection"/>
        ...
        /// The property is set and the <see cref="MessagesCollection"/> is read-only.
        /// </para><para>-or-</para><para>
        /// The property is set, the <b>Messages</b> already contains the
        /// specified element at a different index, and the <b>Messages</b>
        ...
        /// is set, this value must be compatible with <see cref="Message"/>.
        /// </value>
        /// <exception cref="ArgumentOutOfRangeException">
        /// <para><paramref name="index"/> is less than zero.</para>
        /// <para>-or-</para>
        ...
        /// that is not compatible with <see cref="Message"/>.</exception>
        /// <exception cref="NotSupportedException"><para>
        /// The property is set and the <see cref="MessagesCollection"/> is read-only.
        /// </para><para>-or-</para><para>
        /// The property is set, the <b>Messages</b> already contains the
        ...
        /// access to the <see cref="MessagesCollection"/>.
        /// </summary>
        ...
        /// <summary>
        /// Adds an <see cref="Object"/> to the end of the <see cref="MessagesCollection"/>.
        /// </summary>
        /// <param name="value">
        /// The object to be added to the end of the <see cref="MessagesCollection"/>.
        /// This argument must be compatible with <see cref="Message"/>.
        /// This argument can be a null reference.
        /// </param>
        /// <returns>The <see cref="MessagesCollection"/> index at which the
        /// <paramref name="value"/> has been added.</returns>
        /// <exception cref="InvalidCastException"><paramref name="value"/>
        /// is not compatible with <see cref="Message"/>.</exception>
        /// <exception cref="NotSupportedException">
        /// <para>The <see cref="MessagesCollection"/> is read-only.</para>
        /// <para>-or-</para>
        /// <para>The <b>Messages</b> has a fixed size.</para>
        ...
        {
            return Add((Message)value);
        }

        #endregion
        #region AddRange(Messages)
        ...
        /// <summary>
        /// Removes all elements from the <see cref="MessagesCollection"/>.
        /// </summary>
        /// <exception cref="NotSupportedException">
        /// <para>The <see cref="MessagesCollection"/> is read-only.</para>
        /// <para>-or-</para>
        /// <para>The <b>Messages</b> has a fixed size.</para></exception>
        ...
        /// <summary>
        /// Determines whether the <see cref="MessagesCollection"/> contains the specified element.
        /// </summary>
        /// <param name="value">The object to locate in the <see cref="MessagesCollection"/>.
        /// This argument must be compatible with <see cref="Message"/>.
        /// This argument can be a null reference.
        /// </param>
        /// <returns><c>true</c> if <paramref name="value"/> is found in the
        ...
        {
            return Contains((Message)value);
        }

        #endregion
        #region CopyTo(Message[])
        ...
        /// The <see cref="Message"/> type cannot be cast automatically
        ...
        {
            CheckTargetArray(array, arrayIndex);
            CopyTo((Message[])array, arrayIndex);
        }

        #endregion
        #region GetEnumerator: IMessageEnumerator

        /// <summary>
        /// Returns an <see cref="IMessageEnumerator"/> that can
        /// iterate through the <see cref="MessagesCollection"/>.
        /// </summary>
        /// <returns>An <see cref="IMessageEnumerator"/>
        /// for the entire <see cref="MessagesCollection"/>.</returns>
        /// <remarks>Please refer to <see cref="ArrayList.GetEnumerator"/> for details.</remarks>

        public virtual IMessageEnumerator GetEnumerator()
        {
        ...
        #endregion
        #region IndexOf(Message)

        /// <summary>
        /// Returns the zero-based index of the first occurrence of the specified
        /// <see cref="Message"/> in the <see cref="MessagesCollection"/>.
        /// </summary>
        /// <param name="value">The <see cref="Message"/> object
        /// to locate in the <see cref="MessagesCollection"/>.
        /// This argument can be a null reference.
        ...
        /// <returns>
        /// The zero-based index of the first occurrence of <paramref name="value"/>
        /// in the <see cref="MessagesCollection"/>, if found; otherwise, -1.
        /// </returns>
        /// <remarks>Please refer to <see cref="ArrayList.IndexOf"/> for details.</remarks>

        public virtual int IndexOf(Message value)
        {
        ...
        /// <summary>
        /// Returns the zero-based index of the first occurrence of the specified
        /// <see cref="Object"/> in the <see cref="MessagesCollection"/>.
        /// </summary>
        /// <param name="value">The object to locate in the <see cref="MessagesCollection"/>.
        /// This argument must be compatible with <see cref="Message"/>.
        /// This argument can be a null reference.
        ...
        {
            return IndexOf((Message)value);
        }

        #endregion
        #region Insert(Int32, Message)

        /// <summary>
        /// Inserts a <see cref="Message"/> element into the
        /// <see cref="MessagesCollection"/> at the specified index.
        /// </summary>
        /// <param name="index">The zero-based index at which <paramref name="value"/>
        /// should be inserted.</param>
        /// <param name="value">The <see cref="Message"/> object
        /// to insert into the <see cref="MessagesCollection"/>.
        /// This argument can be a null reference.
        /// </param>
        /// <exception cref="ArgumentOutOfRangeException">
        /// <para><paramref name="index"/> is less than zero.</para>
        ...
        public virtual void Insert(int index, Message value)
        {
            if (index < 0)
        ...
        /// <summary>
        /// Inserts an element into the <see cref="MessagesCollection"/> at the specified index.
        /// </summary>
        /// <param name="index">The zero-based index at which <paramref name="value"/>
        /// should be inserted.</param>
        /// <param name="value">The object to insert into the <see cref="MessagesCollection"/>.
        /// This argument must be compatible with <see cref="Message"/>.
        /// This argument can be a null reference.
        /// </param>
        /// <exception cref="ArgumentOutOfRangeException">
        ...
        /// <summary>
        /// Removes the first occurrence of the specified <see cref="Message"/>
        /// from the <see cref="MessagesCollection"/>.
        /// </summary>
        /// <param name="value">The <see cref="Message"/> object
        /// to remove from the <see cref="MessagesCollection"/>.
        /// This argument can be a null reference.
        /// </param>
        /// <exception cref="NotSupportedException">
        /// <para>The <see cref="MessagesCollection"/> is read-only.</para>
        ...
        public virtual void Remove(Message value)
        {
        ...
        /// from the <see cref="MessagesCollection"/>.
        /// </summary>
        /// <param name="value">The object to remove from the <see cref="MessagesCollection"/>.
        /// This argument must be compatible with <see cref="Message"/>.
        /// This argument can be a null reference.
        /// </param>
        /// <exception cref="InvalidCastException"><paramref name="value"/>
        ...
        /// <summary>
        /// Removes the element at the specified index of the <see cref="MessagesCollection"/>.
        /// </summary>
        /// <param name="index">The zero-based index of the element to remove.</param>
        /// <exception cref="ArgumentOutOfRangeException">
        /// <para><paramref name="index"/> is less than zero.</para>
        ...
        /// <summary>
        /// Removes the specified range of elements from the <see cref="MessagesCollection"/>.
        /// </summary>
        ...
        /// valid range of elements in the <see cref="MessagesCollection"/>.</exception>
        /// <exception cref="ArgumentOutOfRangeException">
        /// <para><paramref name="index"/> is less than zero.</para>
        /// <para>-or-</para>
        ...
        /// <see cref="MessagesCollection"/> or a portion of it.
        /// </overloads>
        /// <summary>
        /// Reverses the order of the elements in the entire <see cref="MessagesCollection"/>.
        /// </summary>
        /// <exception cref="NotSupportedException">
        /// The <see cref="MessagesCollection"/> is read-only.</exception>
        ...
        /// <overloads>
        /// Sorts the elements in the <see cref="MessagesCollection"/> or a portion of it.
        /// </overloads>
        /// <summary>
        /// Sorts the elements in the entire <see cref="MessagesCollection"/>
        ...
        /// <summary>
        /// Copies the elements of the <see cref="MessagesCollection"/> to a new
        /// <see cref="Array"/> of <see cref="Message"/> elements.
        /// </summary>
        /// <returns>A one-dimensional <see cref="Array"/> of <see cref="Message"/>
        /// elements containing copies of the elements of the <see cref="MessagesCollection"/>.</returns>
        /// <remarks>Please refer to <see cref="ArrayList.ToArray"/> for details.</remarks>

        public virtual Message[] ToArray()
        {
            Message[] array = new Message[this._count];
            Array.Copy(this._array, array, this._count);
            return array;
        }
        ...
        /// <summary>
        /// Sets the capacity to the actual number of elements in the <see cref="MessagesCollection"/>.
        /// </summary>
        /// <exception cref="NotSupportedException">
        /// <para>The <see cref="MessagesCollection"/> is read-only.</para>
        /// <para>-or-</para>
        ...
        private sealed class Enumerator :
            IMessageEnumerator, IEnumerator
        {
            #region Private Fields

            private readonly MessagesCollection _collection;
        ...
        [Serializable]
        private sealed class ReadOnlyList : MessagesCollection
        {
            #region Private Fields
            ...
            protected override Message[] InnerArray
            {
            ...
            {
                return new ReadOnlyList((MessagesCollection)this._collection.Clone());
            }
            ...
            public override IMessageEnumerator GetEnumerator()
            {
            ...
            public override Message[] ToArray()
            {
        ...
        [Serializable]
        private sealed class SyncList : MessagesCollection
        {
            #region Private Fields
            ...
            {
                lock (this._root)
                    return new SyncList((MessagesCollection)this._collection.Clone());
            }
        ...
        [Serializable]
        private sealed class UniqueList : MessagesCollection
        {
            #region Private Fields
            ...
            public override object Clone()
            {
                return new UniqueList((MessagesCollection)this._collection.Clone());
            }
