...
namespace TestContract.Yuzd.Client
{
    using System;
    ...
    [System.Xml.Serialization.XmlTypeAttribute(Namespace="http://tempuri.org/HelloYuzd.xsd")]
    [System.Xml.Serialization.XmlRootAttribute("HelloWorldRequest", Namespace="http://tempuri.org/HelloYuzd.xsd", IsNullable=false)]
    [DataContract(Name="HelloWorldRequest", Namespace="http://tempuri.org/HelloYuzd.xsd")]
    [ProtoContract()]
    ...
    [System.SerializableAttribute()]
    [System.Xml.Serialization.XmlTypeAttribute(Namespace="http://tempuri.org/HelloYuzd.xsd")]
    [System.Xml.Serialization.XmlRootAttribute(Namespace="http://tempuri.org/HelloYuzd.xsd", IsNullable=false)]
    [Description("测试enum类型")]
    [DataContract(Namespace="http://tempuri.org/HelloYuzd.xsd")]
    [ProtoContract()]
    ...
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    [System.Xml.Serialization.XmlTypeAttribute(Namespace="http://tempuri.org/HelloYuzd.xsd")]
    [System.Xml.Serialization.XmlRootAttribute("HelloWorldResponse", Namespace="http://tempuri.org/HelloYuzd.xsd", IsNullable=false)]
    [DataContract(Name="HelloWorldResponse", Namespace="http://tempuri.org/HelloYuzd.xsd")]
    [ProtoContract()]
    ...
    /// 
    /// </summary>
    public class helloyuzdClient : ServiceClientBase<helloyuzdClient>
    {
        
        public const string CodeGeneratorVersion = "1.0.0.0";
        
        public const string OriginalServiceName = "helloyuzd";
        
        public const string OriginalServiceNamespace = "http://soa.ant.com/nihao/ceshi/v1";
        
        public const string OriginalServiceType = "NonSLB";
        
        private helloyuzdClient(string baseUri) : 
                base(baseUri)
        {
        }
        
        private helloyuzdClient(string serviceName, string serviceNamespace, string subEnv) : 
