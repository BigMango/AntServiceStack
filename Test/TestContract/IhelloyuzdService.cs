...
namespace TestContract.Yuzd
{
    ...
    /// 
    /// </summary>
    [AntServiceInterface("helloyuzd", "http://soa.ant.com/nihao/ceshi/v1", "1.0.0.0")]
    public interface Ihelloyuzd
    {
        
        HelloWorldResponseType HelloWorld(HelloWorldRequestType request);
        
        Task<HelloWorldResponseType> HelloWorldAsync(HelloWorldRequestType request);
    }
}
